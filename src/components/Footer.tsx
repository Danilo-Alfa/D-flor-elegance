...
export function Footer() {
  return (
    <footer className="bg-[var(--card-bg)] border-t border-[var(--border)] mt-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/#produtos" className="text-[var(--muted)] hover:text-[var(--foreground)] transition-colors">
                  Produtos
                </Link>
              </li>
              <li>
                <Link href="/#categorias" className="text-[var(--muted)] hover:text-[var(--foreground)] transition-colors">
                  Categorias
                </Link>
              </li>
              <li>
                <Link href="/#sobre" className="text-[var(--muted)] hover:text-[var(--foreground)] transition-colors">
                  Sobre Nós
                </Link>
              </li>
            </ul>
