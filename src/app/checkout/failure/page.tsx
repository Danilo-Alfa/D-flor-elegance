    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <div className="text-center max-w-md">
        ...
        <p className="text-muted mb-8">
          Infelizmente não foi possível processar o seu pagamento. Isso pode
          acontecer por diversos motivos. Por favor, tente novamente ou escolha
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Link
            href="/"
            className="px-6 py-3 border border-border rounded-xl font-semibold hover:bg-secondary transition-colors"
          >
            Voltar à Loja
          </Link>
        </div>
